...
def load_speaker_profiles(profiles_dir="data/speaker_profiles"):
...
def main():
    ...
    audio_dir = os.path.join("data/audio", args.audio_source)
    ...
    for filename in files_to_process:
        ...
        if args.transcription_provider == "mistral":
            ...
            output_path = os.path.join("output/mistral_transcriptions", output_filename)
            with open(output_path, "w", encoding="utf-8") as f:
                f.write(result)
        else:
